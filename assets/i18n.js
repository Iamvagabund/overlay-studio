...
window.UI = {
  ...
  uk: {
    ...
    fillFirst: "Спершу заповніть", themesTitle: "Готові теми", themesLead: "Усі оверлеї в одному стилі. Виберіть тему, один раз впишіть канал і скопіюйте посилання.", openTheme: "Відкрити тему →", themeTitleSuffix: "безкоштовна тема оверлеїв для OBS", demoNote: "У прев'ю приклад повідомлень. Впишіть свій канал, щоб побачити справжній чат і отримати посилання.",
  },
}[LANG];
